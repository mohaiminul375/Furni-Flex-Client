            ...
            <div className="">
              ...
              <form className="space-y-2">
                ...
                <div>
                  ...
                  <button className="bg-black text-white font-bold rounded-md py-4 w-full">Sign Up</button>
              </form>
              <div className="divider">or</div>
              {/* social login */}
              <SocialLogin></SocialLogin>
              <h2 className="text-center font-semibold mt-5">Have an account? <Link className="text-[#0F3DDE] hover:underline" to='/login'>Sign in</Link></h2>
            </div>
          </div>
        </div>
        {/* bg */}
